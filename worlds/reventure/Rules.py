...
def set_rules(world: MultiWorld, p: int):
    set_rule(world.get_location("StabElder", p), lambda state: state._reventure_has_sword(p))
    set_rule(world.get_location("LonkFaceplant", p), lambda state: state.has("UnlockFacePlantStone", p))
    set_rule(world.get_location("KilledByMinion", p), lambda state: True)
    set_rule(world.get_location("StabGuard", p), lambda state: state._reventure_has_sword(p)),
    set_rule(world.get_location("KillTheKing", p), lambda state: state._reventure_has_sword(p) and state.has("SpawnKing", p))
    set_rule(world.get_location("FallIntoLava", p), lambda state: True)
    set_rule(world.get_location("JumpIntoPiranhaLake", p), lambda state: True)
    set_rule(world.get_location("WaterfallsBottom", p), lambda state: True)
    set_rule(world.get_location("StabShopKeeper", p), lambda state: state._reventure_has_sword(p) and state.has("SpawnShopkeeper", p))
    set_rule(world.get_location("DigIntoBottomlessPit", p), lambda state: state.has("SpawnShovelChest", p))
    set_rule(world.get_location("RescueCat", p), lambda state: state.has("SpawnMrHugsChest", p))
    set_rule(world.get_location("FindFishingRod", p), lambda state: state.has("SpawnFishingRodChest", p))
    set_rule(world.get_location("HugMinion", p), lambda state: state.has("SpawnMrHugsChest", p))
    ...
    set_rule(world.get_location("FallIntoSpikes", p), lambda state: True)
    set_rule(world.get_location("PickupAnvil", p), lambda state: state.has("SpawnAnvilItem", p))
    set_rule(world.get_location("EatenByFakePrincess", p), lambda state: state.has("SpawnMimic", p))
    set_rule(world.get_location("ClimbMountain", p), lambda state: state.has("SpawnStrawberry", p))
    set_rule(world.get_location("StabMinionMultipleTimes", p), lambda state: state._reventure_has_sword(p))
    set_rule(world.get_location("CrushedByOwnStuff", p), lambda state: state._reventure_has_weight(p, 5))
    set_rule(world.get_location("ShootCannonballToCastle", p), lambda state: state._reventure_has_nuke(p) and state.has("UnlockShopCannon", p))
    set_rule(world.get_location("CaughtByOwnBomb", p), lambda state: state.has("SpawnBombsChest", p))
    set_rule(world.get_location("DragonWithShield", p), lambda state: state.has_all(["SpawnDragon", "SpawnShieldChest"], p))
    set_rule(world.get_location("EnterTheChimney", p), lambda state: True)
    set_rule(world.get_location("DestroyAllPots", p), lambda state: state._reventure_has_sword(p))
    set_rule(world.get_location("StabBoulder", p), lambda state: state._reventure_has_sword(p))
    set_rule(world.get_location("LeapOfFaithFromTheMountain", p), lambda state: True)
    set_rule(world.get_location("ElevatorCrush", p), lambda state: state.has_any(["UnlockElevatorButton", "UnlockCallElevatorButtons"], p))
    set_rule(world.get_location("GetIntoThePipe", p), lambda state: True)
    set_rule(world.get_location("DragonWithFireTrinket", p), lambda state: state.has_all(["SpawnDragon", "SpawnLavaTrinketChest"], p))
    set_rule(world.get_location("HugShopkeeper", p), lambda state: state.has_all(["SpawnShopkeeper", "SpawnMrHugsChest"], p))
    set_rule(world.get_location("WrongLever", p), lambda state: True)
    ...
    set_rule(world.get_location("JumpOffTheCliff", p), lambda state: True)
    set_rule(world.get_location("HarakiriSuicide", p), lambda state: state._reventure_has_sword(p))
    set_rule(world.get_location("SelfDestructFortress", p), lambda state: True)
    set_rule(world.get_location("HundredMinionsMassacre", p), lambda state: state._reventure_has_sword(p))
    set_rule(world.get_location("KilledByDarkLord", p), lambda state: state.has("SpawnPrincessItem", p))
    set_rule(world.get_location("TakePrincessBackToTown", p), lambda state: state.has("SpawnPrincessItem", p))
    set_rule(world.get_location("ShootPrincessToTown", p), lambda state: state.has_all(["SpawnPrincessItem", "UnlockDarkCastleCannon"], p))
    set_rule(world.get_location("FallWithPrincessToAnvilPit", p), lambda state: state.has("SpawnPrincessItem", p))
    set_rule(world.get_location("HugBoulder", p), lambda state: state.has("SpawnMrHugsChest", p))
    set_rule(world.get_location("JumpOffTheBalconyWithPrincess", p), lambda state: state.has("SpawnPrincessItem", p))
    set_rule(world.get_location("ShootCannonballToShop", p), lambda state: state._reventure_has_nuke(p) and state.has("UnlockCastleToShopCannon", p))
    set_rule(world.get_location("HugPrincess", p), lambda state: state.has_all(["SpawnMrHugsChest", "SpawnPrincessItem"], p))
    set_rule(world.get_location("JumpOffTheBalcony", p), lambda state: True)
    set_rule(world.get_location("StayAfk", p), lambda state: True)
    ...
    set_rule(world.get_location("SacrificeEveryItem", p), lambda state: state._reventure_has_items(p, 6))
    set_rule(world.get_location("SacrificePrincess", p), lambda state: state.has("SpawnPrincessItem", p))
    set_rule(world.get_location("HugDarkLord", p), lambda state: state.has_all(["SpawnMrHugsChest", "SpawnPrincessItem"], p))
    ...
    set_rule(world.get_location("TakePrincessToLonksHouse", p), lambda state: state.has("SpawnPrincessItem", p))
    set_rule(world.get_location("StayInTheWater", p), lambda state: True)
    set_rule(world.get_location("AboardPirateShip", p), lambda state: True)
