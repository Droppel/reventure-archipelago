...
def set_rules(options: PerGameCommonOptions, multiworld: MultiWorld, p: int):
    ...
    set_rule(multiworld.get_location("62_FindTreasure", p), lambda state: state.has("SpawnShovelChest", p) and (state._reventure_has_sword(p) or state.has_any(["SpawnHookChest", "UnlockGeyserWaterfall"], p)))
    ...
    set_rule(multiworld.get_location("71_SacrificeEveryItem", p), lambda state: state._reventure_has_items(p, 6))
    ...
    set_rule(multiworld.get_location("74_ShotgunFakePrincess", p), lambda state: state._reventure_has_sword(p) and state.has_all(["SpawnShopkeeper", "SpawnMimic", "UnlockShopCannon", "UnlockElevatorButton"], p))
    ...
    set_rule(multiworld.get_location("77_GetIntoTheCloud", p), lambda state: state.has("GrowVine", p) or (state._reventure_has_chicken(p) and (state._reventure_has_sword(p) or state.has_any(["SpawnHookChest", "UnlockGeyserWaterfall"], p))))
    ...
    set_rule(multiworld.get_location("80_TakeChickenToDarkAltar", p), lambda state: state._reventure_has_chicken(p))
    ...
    set_rule(multiworld.get_location("85_KillAllFairies", p), lambda state: state._reventure_has_sword(p) or state.has("SpawnMrHugsChest", p) or (state.has("SpawnBoomerang", p) and (state.has("SpawnHookChest", p) or state._reventure_has_chicken(p))))
    ...
    set_rule(multiworld.get_location("89_FindAlienLarvae", p), lambda state: state.has_any(["SpawnShovelChest", "SpawnPrincessItem"], p))
    set_rule(multiworld.get_location("90_FaceDarkLordWithShield", p), lambda state: state.has_all(["SpawnShieldChest", "SpawnPrincessItem"], p) and (state._reventure_can_reach_princessportal_with_item(p) or (state.has_any(["SpawnHookChest", "UnlockElevatorButton"], p) and (state._reventure_has_sword(p) or state._reventure_has_chicken(p) or state.has_any(["SpawnShovelChest", "UnlockShopCannon", "UnlockGeyserVolcanoe"], p)))))
    ...
    set_rule(multiworld.get_location("98_FeedTheMimic", p), lambda state: state._reventure_has_burger(p) and state.has("SpawnMimic", p) and (state._reventure_can_reach_princessportal_with_item(p) or state.has_any(["SpawnHookChest", "UnlockElevatorButton"], p)))
