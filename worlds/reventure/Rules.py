...
def set_rules(options: PerGameCommonOptions, multiworld: MultiWorld, p: int):
    set_rule(multiworld.get_location("StabElder", p), lambda state: state._reventure_has_sword(p))
    ...
    set_rule(multiworld.get_location("StabBoulder", p), lambda state: state._reventure_has_sword(p))
    ...
    set_rule(multiworld.get_location("GetIntoThePipe", p), lambda state: True)
    ...
    set_rule(multiworld.get_location("WrongLever", p), lambda state: True)
    set_rule(multiworld.get_location("GetIntoBigChest", p), lambda state: True)
    set_rule(multiworld.get_location("HugElder", p), lambda state: state.has("SpawnMrHugsChest", p))
    ...
    set_rule(multiworld.get_location("WrongLever2", p), lambda state: True)
    ...
    set_rule(multiworld.get_location("HugBoulder", p), lambda state: state.has("SpawnMrHugsChest", p))
    ...
    set_rule(multiworld.get_location("DarkStoneToAltar", p), lambda state: state.has("SpawnDarkstoneChest", p))
    ...
    set_rule(multiworld.get_location("GetIntoTheCloud", p), lambda state: state._reventure_has_chicken(p) and state.has("GrowVine", p))
    ...
    set_rule(multiworld.get_location("ShootCannonballToTown", p), lambda state: state._reventure_has_nuke and state.has("UnlockDarkCastleCannon", p))
    ...
    set_rule(multiworld.get_location("GiveDarkStoneToDarkLord", p), lambda state: state.has("SpawnDarkstoneChest", p) and state._reventure_can_reach_princess_with_item(p))
    ...
    set_rule(multiworld.get_location("FeedTheMimic", p), lambda state: state.has_all(["SpawnBurgerChest", "SpawnMimic"], p) and (state._reventure_can_reach_princessportal_with_item(p) or state.has_any(["SpawnHookChest", "UnlockElevatorButton"], p)))
    set_rule(multiworld.get_location("FeedTheKing", p), lambda state: state.has_all(["SpawnBurgerChest", "SpawnKing"], p))
    if options.gems == 0:
